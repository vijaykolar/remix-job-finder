          ...
          <div className="grid grid-cols-12 gap-4">
            <div className="col-span-9 border p-3">
              ...
              <div className="relative">
                <img className="w-full object-cover" src="/bg-images/bg-job.png" alt="" />
                <div className="bg-zinc-100 p-1 size-12 absolute -bottom-6 rounded-sm left-4 -mt-4 -mr-4">
                  <img
                    // className="size-12"
              ...
              <div className="mt-8 flex flex-col gap-4">
                ...
                <div>
                  <Heading size="lg" className="capitalize" weight="bold">
                    about the job
                  </Heading>
                  <p>{job.description}</p>
                </div>
